...
public class LruCacheStatistics {
     ...
     */
    public LruCacheStatistics(long spaceSize) {
     ...
     */
    public long getLimitation() { return this.limitSize; }


    public long getUsage() { return this.usageSpace; }

    /**
     * Increment the number of 'put' requests
     */
    private void incrementPutCount() { this.putCount++; }
    private void decrementPutCount() { this.putCount--; }
